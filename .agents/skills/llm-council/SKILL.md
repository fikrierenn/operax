...
Kullanıcı sorusunu + AGENTS.md / journal / plan bağlamını birleştirerek **tarafsız, net karar çerçevesi** yaz. Yönlendirme yok.
...
- `AGENTS.md` — proje kimliği + kısıtlar
...
- `.Codex/rules/plan-first.md` §3 — 5 lens kontrolü (council'in mini hali, her plan için)
