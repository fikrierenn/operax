...
- AGENTS.md'ye session log yazılmaz (temizlik korunur)
- Yarınki Codex ne olduğuna bakar (SessionStart hook zaten okuyor)
...
2. **AGENTS.md'ye log yazma.** Statik kimlik dosyasıdır.
...
- `.Codex/hooks/session-start.sh` — yarınki oturum bu journal'ı okuyacak
- `.Codex/skills/plan-tracker/SKILL.md` — plan + TODO sync
- `.Codex/rules/session-protocol.md` — oturum protokol detay
- `.Codex/rules/plan-first.md` — Tier 3 plan disiplini
