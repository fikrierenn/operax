...
## İlişkili
- `.claude/skills/operax-erp-wms-auditor/SKILL.md` — endüstri standardı checklist (birlikte çalışır)
- `.claude/skills/mali-evrak-mevzuat/SKILL.md` — TR mevzuat (rakip TR davranışı mevzuattan gelir)
- `.claude/agents/reference-researcher.md` — dış repo/web derin araştırma (proje notu yetmezse)
- `docs/MASTER_EXECUTION_PLAN.md` — gap → faz eşleme
- `.claude/rules/plan-first.md` — gap'ten plana
