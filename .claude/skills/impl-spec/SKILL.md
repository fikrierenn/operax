...
- `.claude/skills/feature-dev` (komut) — Tier tespiti + plan dosyası (bu skill'in girdisi)
- `.claude/agents/code-architect.md` — blueprint (pattern keşfi)
- `.claude/agents/planner.md` — yürütülebilir adım listesi
- `.claude/skills/plan-tracker` — onay sonrası TODO + plan sync
- `.claude/rules/before-major-change.md` §3-4 — aşamalı geçiş + Fact-Force Gate
- `.claude/rules/plan-first.md` — Tier 3 disiplini
- `.claude/rules/phase-review-gate.md` — spec sonrası faz kapanış kapısı
