...
- `.claude/rules/sql-conventions.md` — Tablo/kolon naming, parametreli sorgu
- `.claude/rules/architecture.md` — SQL-first iş mantığı, atomic POST
- `.claude/rules/document-immutability.md` — POSTED kilitleme SP guard
